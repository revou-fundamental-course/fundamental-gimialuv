    ...
    $.fn.modal = function (option) {
        return this.each(function () {
            var $this = $(this),
                ...
                option = $.extend({}, $.fn.modal.defaults, typeof option == 'object' && option)
            if (!data) $this.data('modal', (data = new Modal(this, option)))
            if (typeof option == 'string') data[option]()
            else if (option.show) data.show()
        })
    }
    $.fn.modal.defaults = {
        backdrop: true,
        ...
        ScrollSpy.prototype = {
            ...
            activate: function (target) {
                ...
                $(this.selector)
                    .parent('.active')
                    .removeClass('active')
                selector = this.selector + '[data-target="' + target + '"],' + this.selector +
                        '[href="' + target + '"]'
                active = $(selector)
                    .parent('li')
                    .addClass('active')
            ...
            init: function (type, element, options) {
                ...
                for (i = triggers.length; i--;) {
                    ...
                    if (trigger == 'click') {
                        this
                            .$element
                            .on('click.' + this.type, this.options.selector, $.proxy(this.toggle, this))
                    } else if (trigger != 'manual') {
                        eventIn = trigger == 'hover'
                            ? 'mouseenter'
                            : 'focus'
                        eventOut = trigger == 'hover'
                            ? 'mouseleave'
                            : 'blur'
                        this
                            .$element
    ...
    !function ($) {
        ...
        Typeahead.prototype = {
            ...
            process: function (items) {
                ...
                return this
                    .render(items.slice(0, this.options.items))
                    .show()
            },
