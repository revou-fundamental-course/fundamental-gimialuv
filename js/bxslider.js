...
(function($) {    var plugin = {};
    ...
    $.fn.bxSlider = function (options) {
        ...
        var init = function () {
            ...
            el
                .children(slider.settings.slideSelector)
                .each(function () {
        ...
        var setup = function () {
            ...
            slider
                .viewport
                .parent()
                .css({maxWidth: getViewportMaxWidth()});
            ...
            slider
                .children
                .css({
                    'float': slider.settings.mode == 'horizontal'
                        ? 'left'
                        : 'none',
                    listStyle: 'none',
                    position: 'relative'
            ...
            if (slider.settings.mode == 'fade') {
                slider
                    .children
                    .css({position: 'absolute', zIndex: 0, display: 'none'});
                slider
                    .children
        ...
        var start = function () {
            if (slider.settings.infiniteLoop && slider.settings.mode != 'fade' && !slider.settings.ticker) {
                ...
                var sliceAppend = slider
                    .children
                    .slice(0, slice)
                    .clone()
                    .addClass('bx-clone');
                var slicePrepend = slider
                    .children
                    .slice(-slice)
                    .clone()
                    .addClass('bx-clone');
            ...
            slider
                .settings
                .onSliderLoad(slider.active.index);
        ...
        var getViewportHeight = function () {
            ...
            if (slider.settings.mode != 'vertical' && !slider.settings.adaptiveHeight) {
                ...
                if (!slider.carousel) {
                    ...
                    var currentIndex = slider.settings.moveSlides == 1
                        ? slider.active.index
            ...
            if (slider.settings.mode == 'vertical') {
                ...
                height = Math
                    .max
                    .apply(Math, children.map(function () {
        ...
        var populatePager = function () {
            ...
            for (var i = 0; i < pagerQty; i++) {
                ...
                pagerHtml += '<div class="bx-pager-item"><a href="" data-slide-index="' + i + '" class="bx-p' +
                        'ager-link">' + linkContent + '</a></div>';
            };
            slider
                .pagerEl
                .html(pagerHtml);
        ...
        var appendPager = function () {
            ...
            slider
                .pagerEl
                .delegate('a', 'click', clickPagerBind);
        }
        var appendControls = function () {
            ...
            slider
                .controls
                .next
                .bind('click', clickNextBind);
            slider
                .controls
                .prev
                .bind('click', clickPrevBind);
        ...
        var appendControlsAuto = function () {
            slider.controls.start = $(
                '<div class="bx-controls-auto-item"><a class="bx-start" href="">' + slider.settings.startText +
                '</a></div>'
            );
            slider.controls.stop = $(
                '<div class="bx-controls-auto-item"><a class="bx-stop" href="">' + slider.settings.stopText +
                '</a></div>'
            );
            ...
            slider
                .controls
                .autoEl
                .delegate('.bx-start', 'click', clickStartBind);
            slider
                .controls
                .autoEl
                .delegate('.bx-stop', 'click', clickStopBind);
        ...
        var updatePagerActive = function (slideIndex) {
            ...
            if (slider.settings.pagerType == 'short') {
                ...
                slider
                    .pagerEl
                    .html((slideIndex + 1) + slider.settings.pagerShortSeparator + len);
                return;
            }
            slider
                .pagerEl
        ...
        var initTicker = function () {
            ...
            if (slider.settings.autoDirection == 'next') {
                ...
                var position = slider
                    ...
                    .first()
                    .position();
                startPosition = slider.settings.mode == 'horizontal'
                    ? -position.left
                    : -position.top;
            }
            ...
            if (slider.settings.tickerHover && !slider.usingCSS) {
                slider
                    ...
                    .hover(function () {
                        ...
                        var property = slider.settings.mode == 'horizontal'
                            ? 'left'
                            : 'top';
        ...
        var tickerLoop = function (resumeSpeed) {
            ...
            var animateProperty = slider.settings.mode == 'horizontal'
                ? -position.left
                : -position.top;
        ...
        var onTouchStart = function (e) {
            if (slider.working) {
                ...
                slider.touch.start.x = orig
                    .changedTouches[0]
                    .pageX;
                slider.touch.start.y = orig
                    .changedTouches[0]
                    .pageY;
                slider
                    .viewport
        ...
        var onTouchMove = function (e) {
            ...
            if (slider.settings.mode != 'fade' && slider.settings.oneToOneTouch) {
                ...
                if (slider.settings.mode == 'horizontal') {
                    var change = orig
                        .changedTouches[0]
                        .pageX - slider.touch.start.x;
                    value = slider.touch.originalPos.left + change;
                } else {
                    var change = orig
                        .changedTouches[0]
                        .pageY - slider.touch.start.y;
        ...
        var onTouchEnd = function (e) {
            ...
            var orig = e.originalEvent;
            var value = 0;
            slider.touch.end.x = orig
                .changedTouches[0]
                .pageX;
            slider.touch.end.y = orig
                .changedTouches[0]
                .pageY;
            if (slider.settings.mode == 'fade') {
        ...
        el.goToSlide = function (slideIndex, direction) {
            ...
            if (slider.settings.mode == 'fade') {
                ...
                if ("undefined" !== typeof(position)) {
                    var value = slider.settings.mode == 'horizontal'
