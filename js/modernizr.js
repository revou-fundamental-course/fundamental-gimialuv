...
window.Modernizr = function (a, b, c) {
        ...
        for (var E in p)
            w(p, E) && (u = E.toLowerCase(), e[u] = p[E](), s.push((
                e[u] ?
                "" :
                "no-"
            ) + u));
        return x(""),
            ...
            function (a, b) {
                ...
                function i(a) {
                    ...
                    a.createElement = function (a) {
                        ...
                        a.createDocumentFragment = Function(
                            "h,f",
                            "return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&(" + h().join()
                    ...
                    return a.documentShived ?
                        ...
                        (
                            k.shivCSS && !e && (b = !!g(
                                ...
                                "ay:block}audio{display:none}canvas,video{display:inline-block;*display:inline;" +
                                "*zoom:1}[hidden]{display:none}audio[controls]{display:inline-block;*display:in" +
                                "line;*zoom:1}mark{background:#FF0;color:#000}"
                            )),
                            f || (b = !i(a)),
                ...
                var k = {
                    elements: c.elements ||
                        "abbr article aside audio bdi canvas data datalist details figcaption figure fo" +
                    ...
                    j
                        ...
                        j.bypass || (
                            ...
                            (
                                ...
                                f.load(
                                    j.url,
                                    j.forceCSS || !j.forceJS && "css" == j.url.split(".").pop().split("?").shift() ?
                                    "c" :
                                    c,
                                    j.noexec,
                                    j.attrs,
