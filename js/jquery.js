...
(function (a, b) {
    ...
    function cY(a, b, c) {
        ...
        if (g) {
            ...
            for (d = 0; d < g; d++)
                ...
                n[e] = h[e] || p.style(a, e),
                e in h || (h[e] = i.start, q && (
                    i.end = i.start,
                    i.start = e === "width" || e === "height" ?
                    1 :
                    0
                ))
        }
    ...
    p.fn = p.prototype = {
        ...
        p.extend({
            ...
            makeArray: function (a, b) {
                ...
                return a != null && (
                        c = p.type(a),
                        a.length == null || c === "string" || c === "function" || c === "regexp" || p
                        .isWindow(a) ?
                        j.call(d, a) :
                        p.merge(d, a)
                    ),
            ...
            map: function (a, c, d) {
                var e,
                    ...
                    h = 0,
                    i = a.length,
                    j = a instanceof p || i !== b && typeof i == "number" && (
        ...
        p.support = function () {
            ...
            return p(function () {
                    ...
                    c = e.createElement("div"),
                        c.style.cssText =
                        "visibility:hidden;border:0;width:0;height:0;position:static;top:0;margin-top:1" +
                        "px",
        ...
        p.extend({
            ...
            attr: function (a, c, d, e) {
                ...
                if (typeof a.getAttribute == "undefined")
                    return p.prop(a, c, d);
                h = i !== 1 || !p.isXMLDoc(a),
                    h && (c = c.toLowerCase(), g = p.attrHooks[c] || (
                        T.test(c) ?
                        M :
                        L
                    ));
            ...
            remove: function (a, b, c, d, e) {
                ...
                for (f = 0; f < b.length; f++) {
                    ...
                    for (l = 0; l < o.length; l++)
                        q = o[l],
                        (e || i === q.origType) && (!c || c.guid === q.guid) && (
                    ...
                    o.length === 0 && k !== o.length && (
                        (!n.teardown || n.teardown.call(a, j, r.handle) === !1) && p.removeEvent(a, h, r
                            .handle),
                        delete m[h]
                    )
                }
            ...
            trigger: function (c, d, f, g) {
                if (!f || f.nodeType !== 3 && f.nodeType !== 8) {
                    ...
                    return c.type = s,
                        ...
                        ) && (s !== "click" || !p.nodeName(f, "a")) && p.acceptData(f) && m && f[s] && (
            ...
            mouseHooks: {
                ...
                filter: function (a, c) {
                    ...
                    return a.pageX == null && c.clientX != null && (
                            ...
                            f = d.documentElement,
                            g = d.body,
                            a.pageX = c.clientX + (f && f.scrollLeft || g && g.scrollLeft || 0) - (f && f
                                .clientLeft || g && g.clientLeft || 0),
                            a.pageY = c.clientY + (f && f.scrollTop || g && g.scrollTop || 0) - (f && f
        ...
        p.Event = function (a, b) {
            if (this instanceof p.Event)
                ...
                (
                    ...
                    this.type = a.type,
                    this.isDefaultPrevented = a.defaultPrevented || a.returnValue === !1 || a.getPreventDefault && a
                    .getPreventDefault() ?
                    bb :
                    ba
                ) :
        ...
        p.support.submitBubbles || (p.event.special.submit = {
            ...
            postDispatch: function (a) {
                a._submit_bubble && (
                    ...
                    this.parentNode && !a.isTrigger && p.event.simulate("submit", this.parentNode, a, !
                        0)
                )
            },
            teardown: function () {
            ...
            setup: function () {
                ...
                p
                    ...
                    .add(this, "beforeactivate._change", function (a) {
                        var b = a.target;
                        V.test(b.nodeName) && !p._data(b, "_change_attached") && (
        ...
        function (a, b) {
            ...
            var c,
                ...
                W = {
                    ...
                    POS: new RegExp(K, "i"),
                    CHILD: new RegExp(
                        "^:(only|nth|first|last)-child(?:\\(" + E + "*(even|odd|(([+-]|)(\\d*)n|)" + E +
                        "*(?:([+-]|)" + E + "*(\\d+)|))" + E + "*\\)|)",
                        "i"
                    ),
                ...
                e = bc.selectors = {
                    ...
                    preFilter: {
                        ...
                        PSEUDO: function (a) {
                            ...
                            if (a[3])
                                ...
                                O.test(b) && (c = bh(b, !0)) && (c = b.indexOf(")", b.length - c) - b.length) &&
                                (
                                    b = b.slice(0, c),
                                    a[0] = a[0].slice(0, c)
                                ),
                    ...
                    filter: {
                        ...
                        CLASS: function (a) {
                            ...
                            return b || (b = B(a, new RegExp("(^|" + E + ")" + a + "(" + E + "|$)"))),
                                function (a) {
                                    return b.test(
                                        a.className || typeof a.getAttribute !== n && a.getAttribute(
                                            "class") || ""
                                    )
                                }
                        },
                        ...
                        PSEUDO: function (a, b) {
                            var c,
                                d = e.pseudos[a] || e.setFilters[a.toLowerCase()] || bc.error(
                    ...
                    pseudos: {
                        ...
                        text: function (a) {
                            ...
                            return a
                                .nodeName
                                .toLowerCase() === "input" && (b = a.type) === "text" && (
    ...
    var bl = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|fo" +
    ...
    bz.optgroup = bz.option,
                ...
                return p.access(this, function (a) {
                    ...
                    if (typeof a == "string" && !bs.test(a) && (p.support.htmlSerialize || !bu.test(
                        ...
                        try {
                            for (; d < e; d++)
                                c = this[d] || {},
                                c.nodeType === 1 && (p.cleanData(c.getElementsByTagName("*")), c
                                    .innerHTML = a);
                            c = 0
                        } catch (f) {}
                    }
        ...
        p.buildFragment = function (a, c, d) {
            ...
            return c = c || e,
                c = !c.nodeType && c[0] || c,
                c = c.ownerDocument || c,
                a.length === 1 && typeof i == "string" && i.length < 512 && c === e && i.charAt(
                    0
                ) === "<" && !bt.test(i) && (p.support.checkClone || !bw.test(i)) && (
            ...
            clean: function (a, b, c, d) {
                ...
                if (!p.support.appendChecked)
                    for (f = 0;
                        ...
                        p.nodeName(h, "input") ?
                        bG(h) :
                        typeof h.getElementsByTagName != "undefined" && p.grep(
    ...
    p.Animation = p.extend(cW, {
        ...
        cZ.propHooks = {
            _default: {
                get: function (a) {
                    var b;
                    return a.elem[a.prop] == null || !!a.elem.style && a
                        .elem
                        .style[a.prop] != null ?
                        (
        ...
        p.each([
            ...
            p.fn[b] = function (d, e, f) {
                return d == null || typeof d == "boolean" || !a && p.isFunction(d) && p.isFunction(
                        e
                    ) ?
